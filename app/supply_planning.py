...
#: Виды записей журнала, которыми назначение рассказывает о себе МАТЕРИАЛУ и
#: ПАРТИИ. Собраны в одном месте, потому что читателей у набора двое: сам слой,
#: который эти строки пишет, и наборы проверок, которые отделяют их от прежних
#: событий правки полей.
ALLOCATION_ACTIONS = ("assign", "unassign", "move", "move_in")
