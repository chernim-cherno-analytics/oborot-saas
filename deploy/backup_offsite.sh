...
# Repository не инициализируется автоматически: неверный URL не должен молча
# создать «бэкап» на локальном диске production-машины.
set -euo pipefail
umask 077
...
# Retention только после успешного snapshot: ошибка upload не удаляет старую
# хорошую копию.
